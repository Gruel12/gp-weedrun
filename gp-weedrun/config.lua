...
Config.Payout = math.random(0, 0) -- How much you get paid
Config.Item = math.random(weed_purple-haze, weed_ak47, weed_white-widow) -- The item you receive from the job
Config.MethChance = 10000 -- Percentage chance to get meth
Config.MethAmount = math.random(20, 30) -- Amount of meth you recieve

Config.SpecialRewardChance = 10000 -- Percentage of getting rare item on job. Multiplied by 100. 0.1% = 1, 1% = 10, 20% = 200, 50% = 500, etc. Default 0.1%.
Config.SpecialItem = math.random (weed_purple-haze_seed_m, weed_ak47_seed_m, weed_white-widow_seed_m) -- Put a rare item here which will have 0.1% chance of being given on the run.
config.specialitemamount = math.random(5, 15)

Config.BossLocation = vector3(481.18, -591.21, 23.75)
Config.Itemtime = 300 * 100 -- 5 minutes (time for the case to open after you collect it)
